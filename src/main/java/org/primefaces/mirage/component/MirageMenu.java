...
@ListenerFor(sourceClass = MirageMenu.class, systemEventClass = PostAddToViewEvent.class)
public class MirageMenu extends AbstractMenu implements Widget, ComponentSystemEventListener {

    public static final String COMPONENT_TYPE = "org.primefaces.component.MirageMenu";
    public static final String COMPONENT_FAMILY = "org.primefaces.component";
    private static final String DEFAULT_RENDERER = "org.primefaces.component.MirageMenuRenderer";
